...
const Grid2 = ({ item }) => {
  const { _id, title, image, withDiscount, isAvailable } = item;
        ...
        <div className="product-itemmain me-3">
          <div className="thumbnail-container">
            <div className="tabproductmain-wrapper grid">
              <div className="tabproductmain-image">
                ...
                >
                  <img
                    ...
                    alt="img"
                    className={
                      "tabproductmain-defult-img tv-img-responsive img-fluid"
                    }
                  />
                  <img
              ...
              <div className="tabproductmain-info-box-wrapper" onClick={() => handleProductClick()}>
