...
router.put(
  "/review", isAuthenticatedUser,
  productControllers.createProductReview
);

//Update Product
router.put("/:id", upload, productControllers.updateProduct);
...
router.get("/subCategory/:subcategories", productControllers.getsubCategoryProduct);

// group by product
router.get("/group/:group", productControllers.getgroupProduct);

//product by main category & category 
router.get("/maincategory/:maincategory/category/:category", productControllers.getfiltercategoryP);

// product by maincategory & category & subCategory
router.get("/maincategory/:maincategory/category/:category/subcategories/:subcategories", productControllers.getfilterSubCategoryP);

// product  by maincategory & category & subCategory & group
router.get("/maincategory/:maincategory/category/:category/subcategories/:subcategories/group/:group", productControllers.getfiltergroupp);
